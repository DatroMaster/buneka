...
export function FloatingWhatsappSupport() {
  return (
    <a
      ...
      className="fixed right-4 top-[58%] z-[9999] hidden h-[52px] w-[52px] -translate-y-1/2 items-center justify-center rounded-l-2xl rounded-r-md border border-r-0 border-emerald-300/35 bg-gradient-to-br from-[color:var(--color-primary)] to-emerald-500 text-slate-950 shadow-[0_18px_44px_rgba(62,207,142,0.22)] transition-transform hover:-translate-x-1 hover:scale-105 active:scale-95 sm:inline-flex"
    >
